...
class SettingViewModel extends ChangeNotifier {
  ...
  static final provider = ChangeNotifierProvider<SettingViewModel>((ref) {
  ...
  Future<void> navigateTonetworkscreen() async {
    ...
    // // await AppInformationProvider().clearAppInformationDTO();
    // await NetworkConfigurationProvider().clearNetworkConfigurationDTO();
    // Modular.to.navigateAndRemoveUntil(
    //     AppRoutes.networkConfiguartion, (Route<dynamic> route) => true);
