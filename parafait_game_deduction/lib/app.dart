...
import 'package:game_ride/app_information_builder.dart';
import 'package:game_ride/app_module_manager.dart';
import 'package:game_ride/my_http_overrides.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DynamicTheme(
        ...
        defaultThemeId: AppThemes.light, // optional, default id is 0
